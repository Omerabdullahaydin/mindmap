...
import { knowledgeSourceIngestionParametersSerializer, knowledgeSourceIngestionParametersDeserializer, } from "../knowledgeBases/models.js";
...
export function getIndexStatisticsResultSerializer(item) {
    return item;
}
...
export function analyzedTokenInfoSerializer(item) {
    return item;
}
