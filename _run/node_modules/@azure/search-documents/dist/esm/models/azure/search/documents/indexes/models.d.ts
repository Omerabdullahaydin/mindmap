...
export declare function customAnalyzerSerializer(item: CustomAnalyzer): any;
export declare function customAnalyzerDeserializer(item: any): CustomAnalyzer;
...
export declare function patternAnalyzerSerializer(item: PatternAnalyzer): any;
export declare function patternAnalyzerDeserializer(item: any): PatternAnalyzer;
...
export declare function luceneStandardAnalyzerSerializer(item: LuceneStandardAnalyzer): any;
export declare function luceneStandardAnalyzerDeserializer(item: any): LuceneStandardAnalyzer;
...
export declare function stopAnalyzerSerializer(item: StopAnalyzer): any;
export declare function stopAnalyzerDeserializer(item: any): StopAnalyzer;
export declare function lexicalTokenizerUnionArraySerializer(result: Array<LexicalTokenizerUnion>): any[];
export declare function lexicalTokenizerUnionArrayDeserializer(result: Array<LexicalTokenizerUnion>): any[];
...
export declare function lexicalTokenizerSerializer(item: LexicalTokenizer): any;
export declare function lexicalTokenizerDeserializer(item: any): LexicalTokenizer;
...
export declare function lexicalTokenizerUnionSerializer(item: LexicalTokenizerUnion): any;
export declare function lexicalTokenizerUnionDeserializer(item: any): LexicalTokenizerUnion;
...
export declare function classicTokenizerSerializer(item: ClassicTokenizer): any;
export declare function classicTokenizerDeserializer(item: any): ClassicTokenizer;
...
export declare function edgeNGramTokenizerSerializer(item: EdgeNGramTokenizer): any;
export declare function edgeNGramTokenizerDeserializer(item: any): EdgeNGramTokenizer;
...
export declare function keywordTokenizerSerializer(item: KeywordTokenizer): any;
export declare function keywordTokenizerDeserializer(item: any): KeywordTokenizer;
/** Emits the entire input as a single token. This tokenizer is implemented using Apache Lucene. */
...
export declare function keywordTokenizerV2Serializer(item: KeywordTokenizerV2): any;
export declare function keywordTokenizerV2Deserializer(item: any): KeywordTokenizerV2;
/** Divides text using language-specific rules. */
...
export declare function microsoftLanguageTokenizerSerializer(item: MicrosoftLanguageTokenizer): any;
export declare function microsoftLanguageTokenizerDeserializer(item: any): MicrosoftLanguageTokenizer;
...
export declare function microsoftLanguageStemmingTokenizerSerializer(item: MicrosoftLanguageStemmingTokenizer): any;
export declare function microsoftLanguageStemmingTokenizerDeserializer(item: any): MicrosoftLanguageStemmingTokenizer;
...
export declare function nGramTokenizerSerializer(item: NGramTokenizer): any;
export declare function nGramTokenizerDeserializer(item: any): NGramTokenizer;
...
export declare function pathHierarchyTokenizerV2Serializer(item: PathHierarchyTokenizerV2): any;
export declare function pathHierarchyTokenizerV2Deserializer(item: any): PathHierarchyTokenizerV2;
...
export declare function patternTokenizerSerializer(item: PatternTokenizer): any;
export declare function patternTokenizerDeserializer(item: any): PatternTokenizer;
...
export declare function luceneStandardTokenizerSerializer(item: LuceneStandardTokenizer): any;
export declare function luceneStandardTokenizerDeserializer(item: any): LuceneStandardTokenizer;
/** Breaks text following the Unicode Text Segmentation rules. This tokenizer is implemented using Apache Lucene. */
...
export declare function luceneStandardTokenizerV2Serializer(item: LuceneStandardTokenizerV2): any;
export declare function luceneStandardTokenizerV2Deserializer(item: any): LuceneStandardTokenizerV2;
...
export declare function uaxUrlEmailTokenizerSerializer(item: UaxUrlEmailTokenizer): any;
export declare function uaxUrlEmailTokenizerDeserializer(item: any): UaxUrlEmailTokenizer;
export declare function tokenFilterUnionArraySerializer(result: Array<TokenFilterUnion>): any[];
export declare function tokenFilterUnionArrayDeserializer(result: Array<TokenFilterUnion>): any[];
...
export declare function tokenFilterSerializer(item: TokenFilter): any;
export declare function tokenFilterDeserializer(item: any): TokenFilter;
...
export declare function tokenFilterUnionSerializer(item: TokenFilterUnion): any;
export declare function tokenFilterUnionDeserializer(item: any): TokenFilterUnion;
...
export declare function asciiFoldingTokenFilterSerializer(item: AsciiFoldingTokenFilter): any;
export declare function asciiFoldingTokenFilterDeserializer(item: any): AsciiFoldingTokenFilter;
...
export declare function cjkBigramTokenFilterSerializer(item: CjkBigramTokenFilter): any;
export declare function cjkBigramTokenFilterDeserializer(item: any): CjkBigramTokenFilter;
...
export declare function commonGramTokenFilterSerializer(item: CommonGramTokenFilter): any;
export declare function commonGramTokenFilterDeserializer(item: any): CommonGramTokenFilter;
...
export declare function dictionaryDecompounderTokenFilterSerializer(item: DictionaryDecompounderTokenFilter): any;
export declare function dictionaryDecompounderTokenFilterDeserializer(item: any): DictionaryDecompounderTokenFilter;
...
export declare function edgeNGramTokenFilterSerializer(item: EdgeNGramTokenFilter): any;
export declare function edgeNGramTokenFilterDeserializer(item: any): EdgeNGramTokenFilter;
...
export declare function edgeNGramTokenFilterV2Serializer(item: EdgeNGramTokenFilterV2): any;
export declare function edgeNGramTokenFilterV2Deserializer(item: any): EdgeNGramTokenFilterV2;
...
export declare function elisionTokenFilterSerializer(item: ElisionTokenFilter): any;
export declare function elisionTokenFilterDeserializer(item: any): ElisionTokenFilter;
...
export declare function keepTokenFilterSerializer(item: KeepTokenFilter): any;
export declare function keepTokenFilterDeserializer(item: any): KeepTokenFilter;
...
export declare function keywordMarkerTokenFilterSerializer(item: KeywordMarkerTokenFilter): any;
export declare function keywordMarkerTokenFilterDeserializer(item: any): KeywordMarkerTokenFilter;
...
export declare function lengthTokenFilterSerializer(item: LengthTokenFilter): any;
export declare function lengthTokenFilterDeserializer(item: any): LengthTokenFilter;
...
export declare function limitTokenFilterSerializer(item: LimitTokenFilter): any;
export declare function limitTokenFilterDeserializer(item: any): LimitTokenFilter;
...
export declare function nGramTokenFilterSerializer(item: NGramTokenFilter): any;
export declare function nGramTokenFilterDeserializer(item: any): NGramTokenFilter;
/** Generates n-grams of the given size(s). This token filter is implemented using Apache Lucene. */
...
export declare function nGramTokenFilterV2Serializer(item: NGramTokenFilterV2): any;
export declare function nGramTokenFilterV2Deserializer(item: any): NGramTokenFilterV2;
...
export declare function patternCaptureTokenFilterSerializer(item: PatternCaptureTokenFilter): any;
export declare function patternCaptureTokenFilterDeserializer(item: any): PatternCaptureTokenFilter;
...
export declare function patternReplaceTokenFilterSerializer(item: PatternReplaceTokenFilter): any;
export declare function patternReplaceTokenFilterDeserializer(item: any): PatternReplaceTokenFilter;
...
export declare function phoneticTokenFilterSerializer(item: PhoneticTokenFilter): any;
export declare function phoneticTokenFilterDeserializer(item: any): PhoneticTokenFilter;
...
export declare function shingleTokenFilterSerializer(item: ShingleTokenFilter): any;
export declare function shingleTokenFilterDeserializer(item: any): ShingleTokenFilter;
...
export declare function snowballTokenFilterSerializer(item: SnowballTokenFilter): any;
export declare function snowballTokenFilterDeserializer(item: any): SnowballTokenFilter;
...
export declare function stemmerTokenFilterSerializer(item: StemmerTokenFilter): any;
export declare function stemmerTokenFilterDeserializer(item: any): StemmerTokenFilter;
...
export declare function stemmerOverrideTokenFilterSerializer(item: StemmerOverrideTokenFilter): any;
export declare function stemmerOverrideTokenFilterDeserializer(item: any): StemmerOverrideTokenFilter;
...
export declare function stopwordsTokenFilterSerializer(item: StopwordsTokenFilter): any;
export declare function stopwordsTokenFilterDeserializer(item: any): StopwordsTokenFilter;
...
export declare function synonymTokenFilterSerializer(item: SynonymTokenFilter): any;
export declare function synonymTokenFilterDeserializer(item: any): SynonymTokenFilter;
...
export declare function truncateTokenFilterSerializer(item: TruncateTokenFilter): any;
export declare function truncateTokenFilterDeserializer(item: any): TruncateTokenFilter;
...
export declare function uniqueTokenFilterSerializer(item: UniqueTokenFilter): any;
export declare function uniqueTokenFilterDeserializer(item: any): UniqueTokenFilter;
...
export declare function wordDelimiterTokenFilterSerializer(item: WordDelimiterTokenFilter): any;
export declare function wordDelimiterTokenFilterDeserializer(item: any): WordDelimiterTokenFilter;
export declare function charFilterUnionArraySerializer(result: Array<CharFilterUnion>): any[];
export declare function charFilterUnionArrayDeserializer(result: Array<CharFilterUnion>): any[];
...
export declare function charFilterSerializer(item: CharFilter): any;
export declare function charFilterDeserializer(item: any): CharFilter;
/** Alias for CharFilterUnion */
export type CharFilterUnion = MappingCharFilter | PatternReplaceCharFilter | CharFilter;
export declare function charFilterUnionSerializer(item: CharFilterUnion): any;
export declare function charFilterUnionDeserializer(item: any): CharFilterUnion;
...
export declare function mappingCharFilterSerializer(item: MappingCharFilter): any;
export declare function mappingCharFilterDeserializer(item: any): MappingCharFilter;
...
export declare function patternReplaceCharFilterSerializer(item: PatternReplaceCharFilter): any;
export declare function patternReplaceCharFilterDeserializer(item: any): PatternReplaceCharFilter;
export declare function lexicalNormalizerUnionArraySerializer(result: Array<LexicalNormalizerUnion>): any[];
export declare function lexicalNormalizerUnionArrayDeserializer(result: Array<LexicalNormalizerUnion>): any[];
...
export declare function lexicalNormalizerSerializer(item: LexicalNormalizer): any;
export declare function lexicalNormalizerDeserializer(item: any): LexicalNormalizer;
/** Alias for LexicalNormalizerUnion */
export type LexicalNormalizerUnion = CustomNormalizer | LexicalNormalizer;
export declare function lexicalNormalizerUnionSerializer(item: LexicalNormalizerUnion): any;
export declare function lexicalNormalizerUnionDeserializer(item: any): LexicalNormalizerUnion;
...
export declare function customNormalizerSerializer(item: CustomNormalizer): any;
export declare function customNormalizerDeserializer(item: any): CustomNormalizer;
...
export declare function similarityAlgorithmSerializer(item: SimilarityAlgorithm): any;
export declare function similarityAlgorithmDeserializer(item: any): SimilarityAlgorithm;
...
export declare function similarityAlgorithmUnionSerializer(item: SimilarityAlgorithmUnion): any;
export declare function similarityAlgorithmUnionDeserializer(item: any): SimilarityAlgorithmUnion;
...
export declare function classicSimilaritySerializer(item: ClassicSimilarity): any;
export declare function classicSimilarityDeserializer(item: any): ClassicSimilarity;
...
export declare function bm25SimilaritySerializer(item: BM25Similarity): any;
export declare function bm25SimilarityDeserializer(item: any): BM25Similarity;
/** Defines parameters for a search index that influence semantic capabilities. */
...
export declare function semanticSearchSerializer(item: SemanticSearch): any;
export declare function semanticSearchDeserializer(item: any): SemanticSearch;
export declare function semanticConfigurationArraySerializer(result: Array<SemanticConfiguration>): any[];
export declare function semanticConfigurationArrayDeserializer(result: Array<SemanticConfiguration>): any[];
...
export declare function semanticPrioritizedFieldsSerializer(item: SemanticPrioritizedFields): any;
export declare function semanticPrioritizedFieldsDeserializer(item: any): SemanticPrioritizedFields;
/** A field that is used as part of the semantic configuration. */
export interface SemanticField {
    /** File name */
    name: string;
}
export declare function semanticFieldSerializer(item: SemanticField): any;
export declare function semanticFieldDeserializer(item: any): SemanticField;
export declare function semanticFieldArraySerializer(result: Array<SemanticField>): any[];
export declare function semanticFieldArrayDeserializer(result: Array<SemanticField>): any[];
...
export declare function vectorSearchSerializer(item: VectorSearch): any;
export declare function vectorSearchDeserializer(item: any): VectorSearch;
export declare function vectorSearchProfileArraySerializer(result: Array<VectorSearchProfile>): any[];
export declare function vectorSearchProfileArrayDeserializer(result: Array<VectorSearchProfile>): any[];
...
export declare function vectorSearchProfileSerializer(item: VectorSearchProfile): any;
export declare function vectorSearchProfileDeserializer(item: any): VectorSearchProfile;
export declare function vectorSearchAlgorithmConfigurationUnionArraySerializer(result: Array<VectorSearchAlgorithmConfigurationUnion>): any[];
export declare function vectorSearchAlgorithmConfigurationUnionArrayDeserializer(result: Array<VectorSearchAlgorithmConfigurationUnion>): any[];
/** Contains configuration options specific to the algorithm used during indexing or querying. */
...
export declare function vectorSearchAlgorithmConfigurationSerializer(item: VectorSearchAlgorithmConfiguration): any;
export declare function vectorSearchAlgorithmConfigurationDeserializer(item: any): VectorSearchAlgorithmConfiguration;
...
export declare function vectorSearchAlgorithmConfigurationUnionSerializer(item: VectorSearchAlgorithmConfigurationUnion): any;
export declare function vectorSearchAlgorithmConfigurationUnionDeserializer(item: any): VectorSearchAlgorithmConfigurationUnion;
...
export declare function hnswAlgorithmConfigurationSerializer(item: HnswAlgorithmConfiguration): any;
export declare function hnswAlgorithmConfigurationDeserializer(item: any): HnswAlgorithmConfiguration;
...
export declare function hnswParametersSerializer(item: HnswParameters): any;
export declare function hnswParametersDeserializer(item: any): HnswParameters;
...
export declare function exhaustiveKnnAlgorithmConfigurationSerializer(item: ExhaustiveKnnAlgorithmConfiguration): any;
export declare function exhaustiveKnnAlgorithmConfigurationDeserializer(item: any): ExhaustiveKnnAlgorithmConfiguration;
/** Contains the parameters specific to exhaustive KNN algorithm. */
export interface ExhaustiveKnnParameters {
    /** The similarity metric to use for vector comparisons. */
    metric?: VectorSearchAlgorithmMetric;
}
export declare function exhaustiveKnnParametersSerializer(item: ExhaustiveKnnParameters): any;
export declare function exhaustiveKnnParametersDeserializer(item: any): ExhaustiveKnnParameters;
export declare function vectorSearchVectorizerUnionArraySerializer(result: Array<VectorSearchVectorizerUnion>): any[];
export declare function vectorSearchVectorizerUnionArrayDeserializer(result: Array<VectorSearchVectorizerUnion>): any[];
...
export declare function azureOpenAIVectorizerSerializer(item: AzureOpenAIVectorizer): any;
export declare function azureOpenAIVectorizerDeserializer(item: any): AzureOpenAIVectorizer;
...
export declare function azureOpenAIVectorizerParametersSerializer(item: AzureOpenAIVectorizerParameters): any;
export declare function azureOpenAIVectorizerParametersDeserializer(item: any): AzureOpenAIVectorizerParameters;
...
export declare function webApiVectorizerSerializer(item: WebApiVectorizer): any;
export declare function webApiVectorizerDeserializer(item: any): WebApiVectorizer;
...
export declare function azureMachineLearningVectorizerSerializer(item: AzureMachineLearningVectorizer): any;
export declare function azureMachineLearningVectorizerDeserializer(item: any): AzureMachineLearningVectorizer;
...
export declare function azureMachineLearningParametersSerializer(item: AzureMachineLearningParameters): any;
export declare function azureMachineLearningParametersDeserializer(item: any): AzureMachineLearningParameters;
...
export declare function vectorSearchCompressionUnionArraySerializer(result: Array<VectorSearchCompressionUnion>): any[];
export declare function vectorSearchCompressionUnionArrayDeserializer(result: Array<VectorSearchCompressionUnion>): any[];
/** Contains configuration options specific to the compression method used during indexing or querying. */
...
export declare function vectorSearchCompressionSerializer(item: VectorSearchCompression): any;
export declare function vectorSearchCompressionDeserializer(item: any): VectorSearchCompression;
...
export declare function vectorSearchCompressionUnionSerializer(item: VectorSearchCompressionUnion): any;
export declare function vectorSearchCompressionUnionDeserializer(item: any): VectorSearchCompressionUnion;
/** Contains the options for rescoring. */
...
export declare function rescoringOptionsSerializer(item: RescoringOptions): any;
export declare function rescoringOptionsDeserializer(item: any): RescoringOptions;
...
export declare function scalarQuantizationCompressionSerializer(item: ScalarQuantizationCompression): any;
export declare function scalarQuantizationCompressionDeserializer(item: any): ScalarQuantizationCompression;
/** Contains the parameters specific to Scalar Quantization. */
...
export declare function scalarQuantizationParametersSerializer(item: ScalarQuantizationParameters): any;
export declare function scalarQuantizationParametersDeserializer(item: any): ScalarQuantizationParameters;
/** The quantized data type of compressed vector values. */
...
export declare function searchIndexArrayDeserializer(result: Array<SearchIndex>): any[];
export declare function searchIndexResponseArrayDeserializer(result: Array<SearchIndexResponse>): any[];
/** Represents a search index definition, which describes the fields and search behavior of an index. */
...
export declare function searchIndexResponseDeserializer(item: any): SearchIndexResponse;
...
export declare function getIndexStatisticsResultSerializer(item: GetIndexStatisticsResult): any;
...
export declare function analyzeTextOptionsSerializer(item: AnalyzeTextOptions): any;
/** The result of testing an analyzer on text. */
export interface AnalyzeResult {
    /** The list of tokens returned by the analyzer specified in the request. */
    tokens: AnalyzedTokenInfo[];
}
export declare function analyzeResultSerializer(item: AnalyzeResult): any;
export declare function analyzeResultDeserializer(item: any): AnalyzeResult;
export declare function analyzedTokenInfoArraySerializer(result: Array<AnalyzedTokenInfo>): any[];
export declare function analyzedTokenInfoArrayDeserializer(result: Array<AnalyzedTokenInfo>): any[];
...
export declare function analyzedTokenInfoSerializer(item: AnalyzedTokenInfo): any;
...
export declare function searchAliasSerializer(item: SearchAlias): any;
export declare function searchAliasDeserializer(item: any): SearchAlias;
...
export declare function _listAliasesResultDeserializer(item: any): _ListAliasesResult;
export declare function searchAliasArraySerializer(result: Array<SearchAlias>): any[];
export declare function searchAliasArrayDeserializer(result: Array<SearchAlias>): any[];
...
export declare function knowledgeSourceReferenceArraySerializer(result: Array<KnowledgeSourceReference>): any[];
export declare function knowledgeSourceReferenceArrayDeserializer(result: Array<KnowledgeSourceReference>): any[];
...
export declare function knowledgeBaseModelUnionArraySerializer(result: Array<KnowledgeBaseModelUnion>): any[];
export declare function knowledgeBaseModelUnionArrayDeserializer(result: Array<KnowledgeBaseModelUnion>): any[];
...
export declare function knowledgeBaseModelSerializer(item: KnowledgeBaseModel): any;
export declare function knowledgeBaseModelDeserializer(item: any): KnowledgeBaseModel;
/** Alias for KnowledgeBaseModelUnion */
export type KnowledgeBaseModelUnion = KnowledgeBaseAzureOpenAIModel | KnowledgeBaseModel;
export declare function knowledgeBaseModelUnionSerializer(item: KnowledgeBaseModelUnion): any;
export declare function knowledgeBaseModelUnionDeserializer(item: any): KnowledgeBaseModelUnion;
/** The AI model to be used for query planning. */
...
export declare function knowledgeBaseAzureOpenAIModelSerializer(item: KnowledgeBaseAzureOpenAIModel): any;
export declare function knowledgeBaseAzureOpenAIModelDeserializer(item: any): KnowledgeBaseAzureOpenAIModel;
/** Result from listing knowledge bases. */
export interface _ListKnowledgeBasesResult {
    /** The knowledge bases in the service. */
    value: KnowledgeBase[];
}
export declare function _listKnowledgeBasesResultDeserializer(item: any): _ListKnowledgeBasesResult;
export declare function knowledgeBaseArraySerializer(result: Array<KnowledgeBase>): any[];
export declare function knowledgeBaseArrayDeserializer(result: Array<KnowledgeBase>): any[];
...
export declare function searchIndexKnowledgeSourceSerializer(item: SearchIndexKnowledgeSource): any;
export declare function searchIndexKnowledgeSourceDeserializer(item: any): SearchIndexKnowledgeSource;
...
export declare function searchIndexFieldReferenceArraySerializer(result: Array<SearchIndexFieldReference>): any[];
export declare function searchIndexFieldReferenceArrayDeserializer(result: Array<SearchIndexFieldReference>): any[];
/** Field reference for a search index. */
export interface SearchIndexFieldReference {
    /** The name of the field. */
    name: string;
}
export declare function searchIndexFieldReferenceSerializer(item: SearchIndexFieldReference): any;
export declare function searchIndexFieldReferenceDeserializer(item: any): SearchIndexFieldReference;
...
export declare function azureBlobKnowledgeSourceSerializer(item: AzureBlobKnowledgeSource): any;
export declare function azureBlobKnowledgeSourceDeserializer(item: any): AzureBlobKnowledgeSource;
...
export declare function azureBlobKnowledgeSourceParametersSerializer(item: AzureBlobKnowledgeSourceParameters): any;
export declare function azureBlobKnowledgeSourceParametersDeserializer(item: any): AzureBlobKnowledgeSourceParameters;
...
export declare function indexedOneLakeKnowledgeSourceSerializer(item: IndexedOneLakeKnowledgeSource): any;
export declare function indexedOneLakeKnowledgeSourceDeserializer(item: any): IndexedOneLakeKnowledgeSource;
...
export declare function webKnowledgeSourceSerializer(item: WebKnowledgeSource): any;
export declare function webKnowledgeSourceDeserializer(item: any): WebKnowledgeSource;
...
export declare function webKnowledgeSourceDomainsSerializer(item: WebKnowledgeSourceDomains): any;
export declare function webKnowledgeSourceDomainsDeserializer(item: any): WebKnowledgeSourceDomains;
export declare function webKnowledgeSourceDomainArraySerializer(result: Array<WebKnowledgeSourceDomain>): any[];
export declare function webKnowledgeSourceDomainArrayDeserializer(result: Array<WebKnowledgeSourceDomain>): any[];
...
export declare function _listKnowledgeSourcesResultDeserializer(item: any): _ListKnowledgeSourcesResult;
...
export declare function resourceCounterDeserializer(item: any): ResourceCounter;
...
export declare function searchIndexerDataSourceConnectionSerializer(item: SearchIndexerDataSourceConnection): any;
export declare function searchIndexerDataSourceConnectionDeserializer(item: any): SearchIndexerDataSourceConnection;
...
export declare function dataSourceCredentialsSerializer(item: DataSourceCredentials): any;
export declare function dataSourceCredentialsDeserializer(item: any): DataSourceCredentials;
...
export declare function dataChangeDetectionPolicySerializer(item: DataChangeDetectionPolicy): any;
export declare function dataChangeDetectionPolicyDeserializer(item: any): DataChangeDetectionPolicy;
...
export declare function dataChangeDetectionPolicyUnionSerializer(item: DataChangeDetectionPolicyUnion): any;
export declare function dataChangeDetectionPolicyUnionDeserializer(item: any): DataChangeDetectionPolicyUnion;
...
export declare function highWaterMarkChangeDetectionPolicySerializer(item: HighWaterMarkChangeDetectionPolicy): any;
export declare function highWaterMarkChangeDetectionPolicyDeserializer(item: any): HighWaterMarkChangeDetectionPolicy;
...
export declare function sqlIntegratedChangeTrackingPolicySerializer(item: SqlIntegratedChangeTrackingPolicy): any;
export declare function sqlIntegratedChangeTrackingPolicyDeserializer(item: any): SqlIntegratedChangeTrackingPolicy;
...
export declare function dataDeletionDetectionPolicySerializer(item: DataDeletionDetectionPolicy): any;
export declare function dataDeletionDetectionPolicyDeserializer(item: any): DataDeletionDetectionPolicy;
...
export declare function dataDeletionDetectionPolicyUnionSerializer(item: DataDeletionDetectionPolicyUnion): any;
export declare function dataDeletionDetectionPolicyUnionDeserializer(item: any): DataDeletionDetectionPolicyUnion;
...
export declare function softDeleteColumnDeletionDetectionPolicySerializer(item: SoftDeleteColumnDeletionDetectionPolicy): any;
export declare function softDeleteColumnDeletionDetectionPolicyDeserializer(item: any): SoftDeleteColumnDeletionDetectionPolicy;
...
export declare function nativeBlobSoftDeleteDeletionDetectionPolicySerializer(item: NativeBlobSoftDeleteDeletionDetectionPolicy): any;
export declare function nativeBlobSoftDeleteDeletionDetectionPolicyDeserializer(item: any): NativeBlobSoftDeleteDeletionDetectionPolicy;
...
export declare function indexingParametersSerializer(item: IndexingParameters): any;
export declare function indexingParametersDeserializer(item: any): IndexingParameters;
/** A dictionary of indexer-specific configuration properties. Each name is the name of a specific property. Each value must be of a primitive type. */
...
export declare function indexingParametersConfigurationSerializer(item: IndexingParametersConfiguration): any;
export declare function indexingParametersConfigurationDeserializer(item: any): IndexingParametersConfiguration;
/** Represents the parsing mode for indexing from an Azure blob data source. */
...
export declare function fieldMappingArraySerializer(result: Array<FieldMapping>): any[];
export declare function fieldMappingArrayDeserializer(result: Array<FieldMapping>): any[];
...
export declare function listIndexersResultDeserializer(item: any): ListIndexersResult;
export declare function searchIndexerArraySerializer(result: Array<SearchIndexer>): any[];
export declare function searchIndexerArrayDeserializer(result: Array<SearchIndexer>): any[];
...
export declare function searchIndexerErrorDeserializer(item: any): SearchIndexerError;
export declare function searchIndexerWarningArrayDeserializer(result: Array<SearchIndexerWarning>): any[];
...
export declare function searchIndexerWarningDeserializer(item: any): SearchIndexerWarning;
export declare function indexerExecutionResultArrayDeserializer(result: Array<IndexerExecutionResult>): any[];
...
export declare function searchIndexerSkillsetSerializer(item: SearchIndexerSkillset): any;
export declare function searchIndexerSkillsetDeserializer(item: any): SearchIndexerSkillset;
export declare function searchIndexerSkillUnionArraySerializer(result: Array<SearchIndexerSkillUnion>): any[];
export declare function searchIndexerSkillUnionArrayDeserializer(result: Array<SearchIndexerSkillUnion>): any[];
...
export declare function inputFieldMappingEntryArrayDeserializer(result: Array<InputFieldMappingEntry>): any[];
...
export declare function inputFieldMappingEntrySerializer(item: InputFieldMappingEntry): any;
export declare function inputFieldMappingEntryDeserializer(item: any): InputFieldMappingEntry;
export declare function outputFieldMappingEntryArraySerializer(result: Array<OutputFieldMappingEntry>): any[];
export declare function outputFieldMappingEntryArrayDeserializer(result: Array<OutputFieldMappingEntry>): any[];
...
export declare function outputFieldMappingEntrySerializer(item: OutputFieldMappingEntry): any;
export declare function outputFieldMappingEntryDeserializer(item: any): OutputFieldMappingEntry;
...
export declare function conditionalSkillSerializer(item: ConditionalSkill): any;
export declare function conditionalSkillDeserializer(item: any): ConditionalSkill;
...
export declare function keyPhraseExtractionSkillSerializer(item: KeyPhraseExtractionSkill): any;
export declare function keyPhraseExtractionSkillDeserializer(item: any): KeyPhraseExtractionSkill;
...
export declare function ocrSkillSerializer(item: OcrSkill): any;
export declare function ocrSkillDeserializer(item: any): OcrSkill;
...
export declare function imageAnalysisSkillSerializer(item: ImageAnalysisSkill): any;
export declare function imageAnalysisSkillDeserializer(item: any): ImageAnalysisSkill;
...
export declare function languageDetectionSkillSerializer(item: LanguageDetectionSkill): any;
export declare function languageDetectionSkillDeserializer(item: any): LanguageDetectionSkill;
...
export declare function shaperSkillSerializer(item: ShaperSkill): any;
export declare function shaperSkillDeserializer(item: any): ShaperSkill;
...
export declare function mergeSkillSerializer(item: MergeSkill): any;
export declare function mergeSkillDeserializer(item: any): MergeSkill;
...
export declare function sentimentSkillV3Serializer(item: SentimentSkillV3): any;
export declare function sentimentSkillV3Deserializer(item: any): SentimentSkillV3;
...
export declare function entityLinkingSkillSerializer(item: EntityLinkingSkill): any;
export declare function entityLinkingSkillDeserializer(item: any): EntityLinkingSkill;
...
export declare function entityRecognitionSkillV3Serializer(item: EntityRecognitionSkillV3): any;
export declare function entityRecognitionSkillV3Deserializer(item: any): EntityRecognitionSkillV3;
...
export declare function piiDetectionSkillSerializer(item: PIIDetectionSkill): any;
export declare function piiDetectionSkillDeserializer(item: any): PIIDetectionSkill;
...
export declare function customEntityLookupSkillSerializer(item: CustomEntityLookupSkill): any;
export declare function customEntityLookupSkillDeserializer(item: any): CustomEntityLookupSkill;
...
export declare function customEntityArraySerializer(result: Array<CustomEntity>): any[];
export declare function customEntityArrayDeserializer(result: Array<CustomEntity>): any[];
...
export declare function customEntitySerializer(item: CustomEntity): any;
export declare function customEntityDeserializer(item: any): CustomEntity;
export declare function customEntityAliasArraySerializer(result: Array<CustomEntityAlias>): any[];
export declare function customEntityAliasArrayDeserializer(result: Array<CustomEntityAlias>): any[];
...
export declare function customEntityAliasSerializer(item: CustomEntityAlias): any;
export declare function customEntityAliasDeserializer(item: any): CustomEntityAlias;
...
export declare function textTranslationSkillSerializer(item: TextTranslationSkill): any;
export declare function textTranslationSkillDeserializer(item: any): TextTranslationSkill;
...
export declare function documentExtractionSkillSerializer(item: DocumentExtractionSkill): any;
export declare function documentExtractionSkillDeserializer(item: any): DocumentExtractionSkill;
...
export declare function documentIntelligenceLayoutSkillSerializer(item: DocumentIntelligenceLayoutSkill): any;
export declare function documentIntelligenceLayoutSkillDeserializer(item: any): DocumentIntelligenceLayoutSkill;
...
export declare function documentIntelligenceLayoutSkillChunkingPropertiesSerializer(item: DocumentIntelligenceLayoutSkillChunkingProperties): any;
export declare function documentIntelligenceLayoutSkillChunkingPropertiesDeserializer(item: any): DocumentIntelligenceLayoutSkillChunkingProperties;
...
export declare function webApiSkillSerializer(item: WebApiSkill): any;
export declare function webApiSkillDeserializer(item: any): WebApiSkill;
...
export declare function contentUnderstandingSkillSerializer(item: ContentUnderstandingSkill): any;
export declare function contentUnderstandingSkillDeserializer(item: any): ContentUnderstandingSkill;
/** Controls the cardinality of the content extracted from the document by the skill. */
...
export declare function contentUnderstandingSkillChunkingPropertiesSerializer(item: ContentUnderstandingSkillChunkingProperties): any;
export declare function contentUnderstandingSkillChunkingPropertiesDeserializer(item: any): ContentUnderstandingSkillChunkingProperties;
/** Controls the cardinality of the chunk unit. Default is 'characters' */
...
export declare function chatCompletionSkillSerializer(item: ChatCompletionSkill): any;
export declare function chatCompletionSkillDeserializer(item: any): ChatCompletionSkill;
...
export declare function commonModelParametersSerializer(item: CommonModelParameters): any;
export declare function commonModelParametersDeserializer(item: any): CommonModelParameters;
...
export declare function chatCompletionResponseFormatSerializer(item: ChatCompletionResponseFormat): any;
export declare function chatCompletionResponseFormatDeserializer(item: any): ChatCompletionResponseFormat;
/** Specifies how the LLM should format the response. */
...
export declare function chatCompletionSchemaPropertiesSerializer(item: ChatCompletionSchemaProperties): any;
export declare function chatCompletionSchemaPropertiesDeserializer(item: any): ChatCompletionSchemaProperties;
...
export declare function chatCompletionSchemaSerializer(item: ChatCompletionSchema): any;
export declare function chatCompletionSchemaDeserializer(item: any): ChatCompletionSchema;
...
export declare function cognitiveServicesAccountSerializer(item: CognitiveServicesAccount): any;
export declare function cognitiveServicesAccountDeserializer(item: any): CognitiveServicesAccount;
...
export declare function cognitiveServicesAccountUnionSerializer(item: CognitiveServicesAccountUnion): any;
export declare function cognitiveServicesAccountUnionDeserializer(item: any): CognitiveServicesAccountUnion;
...
export declare function defaultCognitiveServicesAccountSerializer(item: DefaultCognitiveServicesAccount): any;
export declare function defaultCognitiveServicesAccountDeserializer(item: any): DefaultCognitiveServicesAccount;
...
export declare function cognitiveServicesAccountKeySerializer(item: CognitiveServicesAccountKey): any;
export declare function cognitiveServicesAccountKeyDeserializer(item: any): CognitiveServicesAccountKey;
...
export declare function aiServicesAccountKeySerializer(item: AIServicesAccountKey): any;
export declare function aiServicesAccountKeyDeserializer(item: any): AIServicesAccountKey;
...
export declare function aiServicesAccountIdentitySerializer(item: AIServicesAccountIdentity): any;
export declare function aiServicesAccountIdentityDeserializer(item: any): AIServicesAccountIdentity;
/** Definition of additional projections to azure blob, table, or files, of enriched data. */
...
export declare function searchIndexerKnowledgeStoreProjectionArraySerializer(result: Array<SearchIndexerKnowledgeStoreProjection>): any[];
export declare function searchIndexerKnowledgeStoreProjectionArrayDeserializer(result: Array<SearchIndexerKnowledgeStoreProjection>): any[];
...
export declare function searchIndexerKnowledgeStoreProjectionSerializer(item: SearchIndexerKnowledgeStoreProjection): any;
export declare function searchIndexerKnowledgeStoreProjectionDeserializer(item: any): SearchIndexerKnowledgeStoreProjection;
export declare function searchIndexerKnowledgeStoreTableProjectionSelectorArraySerializer(result: Array<SearchIndexerKnowledgeStoreTableProjectionSelector>): any[];
export declare function searchIndexerKnowledgeStoreTableProjectionSelectorArrayDeserializer(result: Array<SearchIndexerKnowledgeStoreTableProjectionSelector>): any[];
...
export declare function searchIndexerKnowledgeStoreTableProjectionSelectorSerializer(item: SearchIndexerKnowledgeStoreTableProjectionSelector): any;
export declare function searchIndexerKnowledgeStoreTableProjectionSelectorDeserializer(item: any): SearchIndexerKnowledgeStoreTableProjectionSelector;
export declare function searchIndexerKnowledgeStoreObjectProjectionSelectorArraySerializer(result: Array<SearchIndexerKnowledgeStoreObjectProjectionSelector>): any[];
export declare function searchIndexerKnowledgeStoreObjectProjectionSelectorArrayDeserializer(result: Array<SearchIndexerKnowledgeStoreObjectProjectionSelector>): any[];
...
export declare function searchIndexerKnowledgeStoreObjectProjectionSelectorSerializer(item: SearchIndexerKnowledgeStoreObjectProjectionSelector): any;
export declare function searchIndexerKnowledgeStoreObjectProjectionSelectorDeserializer(item: any): SearchIndexerKnowledgeStoreObjectProjectionSelector;
export declare function searchIndexerKnowledgeStoreFileProjectionSelectorArraySerializer(result: Array<SearchIndexerKnowledgeStoreFileProjectionSelector>): any[];
export declare function searchIndexerKnowledgeStoreFileProjectionSelectorArrayDeserializer(result: Array<SearchIndexerKnowledgeStoreFileProjectionSelector>): any[];
...
export declare function searchIndexerIndexProjectionSerializer(item: SearchIndexerIndexProjection): any;
export declare function searchIndexerIndexProjectionDeserializer(item: any): SearchIndexerIndexProjection;
export declare function searchIndexerIndexProjectionSelectorArraySerializer(result: Array<SearchIndexerIndexProjectionSelector>): any[];
export declare function searchIndexerIndexProjectionSelectorArrayDeserializer(result: Array<SearchIndexerIndexProjectionSelector>): any[];
...
export declare function searchIndexerIndexProjectionSelectorSerializer(item: SearchIndexerIndexProjectionSelector): any;
export declare function searchIndexerIndexProjectionSelectorDeserializer(item: any): SearchIndexerIndexProjectionSelector;
/** A dictionary of index projection-specific configuration properties. Each name is the name of a specific property. Each value must be of a primitive type. */
...
export declare function searchIndexerIndexProjectionsParametersSerializer(item: SearchIndexerIndexProjectionsParameters): any;
export declare function searchIndexerIndexProjectionsParametersDeserializer(item: any): SearchIndexerIndexProjectionsParameters;
/** Defines behavior of the index projections in relation to the rest of the indexer. */
...
export declare function searchIndexerKnowledgeStoreProjectionSelectorSerializer(item: SearchIndexerKnowledgeStoreProjectionSelector): any;
export declare function searchIndexerKnowledgeStoreProjectionSelectorDeserializer(item: any): SearchIndexerKnowledgeStoreProjectionSelector;
/** Abstract class to share properties between concrete selectors. */
...
export declare function searchIndexerKnowledgeStoreBlobProjectionSelectorSerializer(item: SearchIndexerKnowledgeStoreBlobProjectionSelector): any;
export declare function searchIndexerKnowledgeStoreBlobProjectionSelectorDeserializer(item: any): SearchIndexerKnowledgeStoreBlobProjectionSelector;
...
export declare function skillNamesSerializer(item: SkillNames): any;
export declare function _searchResourceEncryptionKeyAccessCredentialsSerializer(item: SearchResourceEncryptionKey): any;
export declare function _searchResourceEncryptionKeyAccessCredentialsDeserializer(item: any): {
    applicationId: any;
    applicationSecret: any;
};
export declare function _searchIndexerDataSourceConnectionCredentialsSerializer(item: SearchIndexerDataSourceConnection): any;
export declare function _searchIndexerDataSourceConnectionCredentialsDeserializer(item: any): {
